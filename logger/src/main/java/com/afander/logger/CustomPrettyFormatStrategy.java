 ...
 * <h3>Customize</h3>
 * <pre><code>
 *   FormatStrategy formatStrategy = CustomPrettyFormatStrategy.newBuilder()
 ...
 * </code></pre>
 */
class CustomPrettyFormatStrategy implements FormatStrategy {
     ...
     */
    private static final int MIN_STACK_OFFSET = 7; ///ice修改过, 本来为5，代理后需修改。
    ...
    private CustomPrettyFormatStrategy(@NonNull Builder builder) {
    ...
    private int getStackOffset(@NonNull StackTraceElement[] trace) {
        ...
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(CustomLoggerPrinter.class.getName())
                    && !name.equals(LoggerUtil.class.getName())
    ...
    public static class Builder {
        ...
        @Nullable String tag = "AFANDER_LOGGER";
        ...
        @NonNull
        public CustomPrettyFormatStrategy build() {
            if (logStrategy == null) {
                logStrategy = new LogcatLogStrategy();
            }
            return new CustomPrettyFormatStrategy(this);
        }
    }
