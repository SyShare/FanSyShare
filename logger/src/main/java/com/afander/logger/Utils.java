 ...
 * {@link com.orhanobut.logger.Utils}
 */
final class Utils {
    ...
    static boolean deleteFileBySuffix(String fileDir, String suffix) {
        if (fileDir != null) {
            ...
            if (file.isDirectory()) {
                File[] files = file.listFiles(new FilenameFilter() {
                    ...
                    public boolean accept(File dir, String name) {
                        return (name.contains(DiskLogStrategy.sFileSuffix));
                    }
                });
                for (File cvsFile : files) {
                    cvsFile.delete();
                }
            }
            return file.delete();
